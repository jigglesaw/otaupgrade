...
def run_fota(module=None):
    ...
    if module == 'ALL':
        download_list = [{'url': 'https://github.com/jigglesaw/otaupgrade/blob/38cb45e0e7b0836d28864a8935fd4d062e6f660c/{}'.format(MODULE_FILES[module]), 'file_name': '/usr/'+filename} for module, filename in MODULE_FILES.items()]
        ...
        module_index = module
        url = "https://github.com/jigglesaw/otaupgrade/blob/38cb45e0e7b0836d28864a8935fd4d062e6f660c/{}".format(MODULE_FILES[module_index])
